# Compute and plot the bifurcation diagram for a range of influx values.
...
# Simulate and plot the number of influx options for each (P0, influx) pair.
...
# Simulate and plot the range of reachable states after one decision step.
