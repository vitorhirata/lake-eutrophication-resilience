# Load and plot how normalized entropy scales with initial states across option counts.
...
# Load and plot how entropy varies with decision step size and time horizon.
